    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        ...
        <div style="float: right">
          ...
          >添加</el-button>
          <el-dialog title="新增教师" :visible.sync="create" width="400px">
            <el-form ref="createForm" :model="createForm" label-width="120px">
              ...
              <el-form-item label="联系电话: ">
                <el-input v-model="createForm.telephone" style="width: 200px" placeholder="请输入联系电话"></el-input>
              </el-form-item>
              <el-form-item label="最大借书量: ">
                <el-input
                  v-model="createForm.maxborrow"
                  style="width: 200px"
            ...
            <div slot="footer" class="dialog-footer" align="center">
              <el-button @click="createTeacher()">提 交</el-button>
          ...
          <el-dialog title="详细信息" :visible.sync="detailMsg" width="400px">
            <template v-if="editForm !== null">
              <el-form ref="editForm" :model="editForm" label-width="120px">
                ...
                <el-form-item label="年龄: ">
                  <el-input v-model="editForm.age" style="width: 80px" placeholder="请输入年龄"></el-input>
                </el-form-item>
                <el-form-item label="联系电话: ">
                  <el-input v-model="editForm.telephone" style="width: 200px" placeholder="请输入联系电话"></el-input>
                </el-form-item>
                <el-form-item label="最大借书量: ">
                  <el-input v-model="editForm.maxborrow" style="width: 80px" placeholder="请输入最大借书量"></el-input>
                </el-form-item>
                <el-form-item label="性别: ">
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .get(
          "http://localhost/lms_api/getUserInfo.php?role=teacher&currentPage=" +
            _this.currentPage +
            "&pageSize=" +
            _this.pageSize
        )
    ...
    createTeacher() {
      ...
      this.$axios
        ...
        .then((res) => {
          if (res.data === "success") {
            _this.$message.success("新建教师信息成功", 500);
            setTimeout(() => {
              window.location.reload();
            }, 500);
          }
          else if (res.data === "existed") {
            _this.$message.error("请检查是否该教师已存在", 500);
          }
          else {
            console.log("新建教师信息失败");
          }
        });
    },
    // 删除教师信息
