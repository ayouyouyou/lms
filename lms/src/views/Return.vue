      ...
      <div slot="header" class="clearfix">
        ...
        <div style="float: right">
          ...
          <el-button
            ...
            >添加</el-button
          >
          <el-dialog title="新增归还记录" :visible.sync="create" width="400px">
            <el-form ref="createForm" :model="createForm" label-width="100px">
              ...
              <el-form-item label="实归还时间: ">
                <el-date-picker
                  v-model="createForm.actual_return_date"
                  type="date"
                  :editable="false"
                  placeholder="选择日期"
                  format="yyyy 年 MM 月 dd 日"
            ...
            <div slot="footer" class="dialog-footer" align="center">
              <el-button type="success" @click="createRevert()"
                >提 交</el-button
              >
            ...
            <template v-if="editForm !== null">
              <el-form ref="editForm" :model="editForm" label-width="150px">
                ...
                <el-form-item label="实际归还时间: ">
                  <el-date-picker
                    v-model="editForm.actual_return_date"
                    type="date"
                    :editable="false"
                    placeholder="选择日期"
                    format="yyyy 年 MM 月 dd 日"
